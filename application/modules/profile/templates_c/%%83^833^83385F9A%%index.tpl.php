<?php /* Smarty version 2.6.26, created on 2009-10-01 11:26:06
...
<h2>Welcome <?php echo $this->_tpl_vars['user']->name; ?>
 !</h2>
...
?>
			<p class=<?php if ((1 & $this->_tpl_vars['value'])): ?>"odd"<?php else: ?>"even"<?php endif; ?>>
 ...
 : <?php echo $this->_tpl_vars['value']; ?>
	  ...
	  <?php else: ?>
		pleace <a href="<?php echo $this->_tpl_vars['PUBLIC_URL']; ?>
/login">login</a>!
	  <?php endif; ?>	
	</div>
	<div id="tabs-2">
...
<div style="display:none;" id="dialog" title="Welcome to my world~">
